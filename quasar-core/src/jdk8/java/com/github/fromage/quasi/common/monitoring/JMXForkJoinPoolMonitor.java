 ...
 */
package com.github.fromage.quasi.common.monitoring;
...
import com.github.fromage.quasi.common.monitoring.ExecutorServiceLatencyProbe;
import com.github.fromage.quasi.common.monitoring.ForkJoinInfo;
import com.github.fromage.quasi.common.monitoring.ForkJoinPoolMXBean;
...
public class JMXForkJoinPoolMonitor extends ForkJoinPoolMonitor implements ForkJoinPoolMXBean {
    ...
    public JMXForkJoinPoolMonitor(String name, ForkJoinPool fjPool) {
        ...
        this.mbeanName = "com.github.fromage.quasi:type=ForkJoinPool,name=" + name;
        registerMBean();
    }
