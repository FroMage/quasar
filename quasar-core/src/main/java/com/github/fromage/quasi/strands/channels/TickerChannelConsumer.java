...
import com.github.fromage.quasi.strands.queues.CircularBuffer;
...
/**
 * A {@link ReceivePort} which is a view of a {@link Channels#newTickerConsumerFor(com.github.fromage.quasi.strands.channels.Channel) <i>ticker channel</i>}.
