...
import static com.github.fromage.quasi.fibers.FiberTask.*;
...
import com.github.fromage.quasi.strands.SettableFuture;
...
class RunnableFiberTask<V> implements Runnable, FiberTask {
    ...
    public static final boolean CAPTURE_UNPARK_STACK = Debug.isDebug() || SystemProperties.isEmptyOrTrue("com.github.fromage.quasi.fibers.captureUnparkStackTrace");
