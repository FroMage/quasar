 ...
 */
package com.github.fromage.quasi.fibers;

import static com.github.fromage.quasi.strands.SuspendableUtils.runnableToCallable;
...
import com.github.fromage.quasi.common.reflection.ASMUtil;
import com.github.fromage.quasi.common.util.Debug;
import com.github.fromage.quasi.common.util.Exceptions;
import com.github.fromage.quasi.common.util.ExtendedStackTrace;
import com.github.fromage.quasi.common.util.ExtendedStackTraceElement;
import com.github.fromage.quasi.common.util.Objects;
import com.github.fromage.quasi.common.util.Pair;
import com.github.fromage.quasi.common.util.SystemProperties;
import com.github.fromage.quasi.common.util.UtilUnsafe;
import com.github.fromage.quasi.common.util.VisibleForTesting;
import com.github.fromage.quasi.concurrent.util.ThreadAccess;
import com.github.fromage.quasi.concurrent.util.ThreadUtil;
import com.github.fromage.quasi.fibers.FiberForkJoinScheduler;
import com.github.fromage.quasi.fibers.FiberForkJoinScheduler.FiberForkJoinTask;
import com.github.fromage.quasi.fibers.instrument.SuspendableHelper;
import com.github.fromage.quasi.io.serialization.ByteArraySerializer;
import com.github.fromage.quasi.io.serialization.kryo.KryoSerializer;
import com.github.fromage.quasi.strands.Strand;
import com.github.fromage.quasi.strands.Stranded;
import com.github.fromage.quasi.strands.SuspendableCallable;
import com.github.fromage.quasi.strands.SuspendableRunnable;
import com.github.fromage.quasi.strands.SuspendableUtils.VoidSuspendableCallable;
import com.github.fromage.quasi.strands.dataflow.Val;
...
public class Fiber<V> extends Strand implements Joinable<V>, Serializable, Future<V> {
    ...
    private static final boolean traceInterrupt = SystemProperties.isEmptyOrTrue("com.github.fromage.quasi.fibers.traceInterrupt");
    private static final boolean disableAgentWarning = SystemProperties.isEmptyOrTrue("com.github.fromage.quasi.fibers.disableAgentWarning");
...
//    private static final boolean PREEMPTION = SystemProperties.isEmptyOrTrue("com.github.fromage.quasi.fibers.enablePreemption");
//    private static final int PREEMPTION_CREDITS = 3000;
    ...
    private static final boolean verifyInstrumentation = SystemProperties.isEmptyOrTrue("com.github.fromage.quasi.fibers.verifyInstrumentation");
    ...
    private static volatile UncaughtExceptionHandler defaultUncaughtExceptionHandler = new UncaughtExceptionHandler() {
        ...
        public void uncaughtException(Strand s, Throwable e) {
            ...
            if (e instanceof NullPointerException || e instanceof ClassCastException
                ...
                System.err.println("If this exception looks strange, perhaps you've forgotten to instrument a blocking method. Run your program with -Dcom.github.fromage.quasi.fibers.verifyInstrumentation to catch the culprit!");
        ...
        if (fromUncaughtExc && st.get().length > 0 && st.get()[0] != null) {
            ...
            if (!first.getDeclaringClass().equals(ClassCastException.class)
                && !(first.getDeclaringClass().equals(NullPointerException.class) &&
                     first.getDeclaringClass().getName().startsWith("com.github.fromage.quasi.fibers")))
                return true;
        }
