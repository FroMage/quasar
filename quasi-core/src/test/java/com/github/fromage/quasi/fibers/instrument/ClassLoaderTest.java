...
import com.github.fromage.quasi.common.test.*;
import com.github.fromage.quasi.fibers.*;
import com.github.fromage.quasi.strands.*;

import java.lang.reflect.*;
import java.net.*;
import java.util.*;

import static com.github.fromage.quasi.fibers.TestsHelper.*;
    ...
    public void testSuspendableMethodsLoadedDynamically() {
        ...
        try {
            try {
                ...
                Class<?> testClass = cl.loadClass("com.github.fromage.quasi.fibers.dynamic.DynamicallyLoadedSuspendable");
    ...
    public void testSuspendableClassLoadedTwice() {
        ...
        try {
            try {
                ...
                Class<?> testClass1 = cl1.loadClass("com.github.fromage.quasi.fibers.dynamic.DynamicallyLoadedSuspendable");
                Class<?> testClass2 = cl2.loadClass("com.github.fromage.quasi.fibers.dynamic.DynamicallyLoadedSuspendable");
    ...
    public void testDynamicallyLoadedFiber() {
        ...
        try {
            try {
                ...
                System.out.println(testClassesURL.toString());
                ClassLoader cl = new URLClassLoader(new URL[]{testClassesURL});
                Class<?> testClass = cl.loadClass("com.github.fromage.quasi.fibers.dynamic.DynamicallyLoadedFiber");
                Constructor<?> constructor = testClass.getConstructor();
