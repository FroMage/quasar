 ...
 */
package com.github.fromage.quasi.common.util;
 ...
 */
public class Debug {
    private static final boolean debugMode = SystemProperties.isEmptyOrTrue("com.github.fromage.quasi.debugMode");
    private static final String FLIGHT_RECORDER_DUMP_FILE = System.getProperty("com.github.fromage.quasi.flightRecorderDumpFile");
    private static final FlightRecorder flightRecorder = (debugMode && SystemProperties.isEmptyOrTrue("com.github.fromage.quasi.globalFlightRecorder") ? new FlightRecorder("PUNIVERSE-FLIGHT-RECORDER") : null);
