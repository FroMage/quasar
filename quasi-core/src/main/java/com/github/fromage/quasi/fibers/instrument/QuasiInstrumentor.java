...
public final class QuasiInstrumentor {
    ...
    private final static String EXAMINED_CLASS = System.getProperty("com.github.fromage.quasi.fibers.writeInstrumentedClasses");
    private static final boolean allowJdkInstrumentation = SystemProperties.isEmptyOrTrue("com.github.fromage.quasi.fibers.allowJdkInstrumentation");
