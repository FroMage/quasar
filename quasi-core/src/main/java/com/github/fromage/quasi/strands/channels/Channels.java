...
import com.github.fromage.quasi.common.util.DelegatingEquals;
import com.github.fromage.quasi.common.util.Function2;
import com.github.fromage.quasi.common.util.Function3;
import com.github.fromage.quasi.common.util.Function4;
import com.github.fromage.quasi.common.util.Function5;
import com.github.fromage.quasi.fibers.DefaultFiberScheduler;
import com.github.fromage.quasi.fibers.FiberFactory;
import com.github.fromage.quasi.fibers.SuspendExecution;
import com.github.fromage.quasi.strands.SuspendableAction1;
import com.github.fromage.quasi.strands.SuspendableAction2;
...
import com.github.fromage.quasi.strands.queues.ArrayQueue;
import com.github.fromage.quasi.strands.queues.BasicQueue;
import com.github.fromage.quasi.strands.queues.BasicSingleConsumerDoubleQueue;
import com.github.fromage.quasi.strands.queues.BasicSingleConsumerFloatQueue;
import com.github.fromage.quasi.strands.queues.BasicSingleConsumerIntQueue;
import com.github.fromage.quasi.strands.queues.BasicSingleConsumerLongQueue;
import com.github.fromage.quasi.strands.queues.BoxQueue;
import com.github.fromage.quasi.strands.queues.CircularDoubleBuffer;
import com.github.fromage.quasi.strands.queues.CircularFloatBuffer;
import com.github.fromage.quasi.strands.queues.CircularIntBuffer;
import com.github.fromage.quasi.strands.queues.CircularLongBuffer;
import com.github.fromage.quasi.strands.queues.CircularObjectBuffer;
import com.github.fromage.quasi.strands.queues.SingleConsumerArrayDoubleQueue;
import com.github.fromage.quasi.strands.queues.SingleConsumerArrayFloatQueue;
import com.github.fromage.quasi.strands.queues.SingleConsumerArrayIntQueue;
import com.github.fromage.quasi.strands.queues.SingleConsumerArrayLongQueue;
import com.github.fromage.quasi.strands.queues.SingleConsumerArrayObjectQueue;
import com.github.fromage.quasi.strands.queues.SingleConsumerLinkedArrayDoubleQueue;
import com.github.fromage.quasi.strands.queues.SingleConsumerLinkedArrayFloatQueue;
import com.github.fromage.quasi.strands.queues.SingleConsumerLinkedArrayIntQueue;
import com.github.fromage.quasi.strands.queues.SingleConsumerLinkedArrayLongQueue;
import com.github.fromage.quasi.strands.queues.SingleConsumerLinkedArrayObjectQueue;
...
public final class Channels {
     ...
     * @param policy     the {@link OverflowPolicy} specifying how the channel (if bounded) will behave if its internal buffer overflows.
     * @return The newly created channel
     * @see #newChannel(int, com.github.fromage.quasi.strands.channels.Channels.OverflowPolicy, boolean, boolean)
     */
     ...
     * @param policy     the {@link OverflowPolicy} specifying how the channel (if bounded) will behave if its internal buffer overflows.
     * @return The newly created channel
     * @see #newIntChannel(int, com.github.fromage.quasi.strands.channels.Channels.OverflowPolicy, boolean, boolean)
     */
     ...
     * @param policy     the {@link OverflowPolicy} specifying how the channel (if bounded) will behave if its internal buffer overflows.
     * @return The newly created channel
     * @see #newLongChannel(int, com.github.fromage.quasi.strands.channels.Channels.OverflowPolicy, boolean, boolean)
     */
     ...
     * @param policy     the {@link OverflowPolicy} specifying how the channel (if bounded) will behave if its internal buffer overflows.
     * @return The newly created channel
     * @see #newFloatChannel(int, com.github.fromage.quasi.strands.channels.Channels.OverflowPolicy, boolean, boolean)
     */
     ...
     * @param policy     the {@link OverflowPolicy} specifying how the channel (if bounded) will behave if its internal buffer overflows.
     * @return The newly created channel
     * @see #newDoubleChannel(int, com.github.fromage.quasi.strands.channels.Channels.OverflowPolicy, boolean, boolean)
     */
