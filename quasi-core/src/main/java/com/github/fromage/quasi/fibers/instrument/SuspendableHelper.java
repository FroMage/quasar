...
public final class SuspendableHelper {
    ...
    public static boolean isWaiver(String className, String methodName) {
        return
            ...
            (className.equals("com.github.fromage.quasi.strands.SuspendableUtils$VoidSuspendableCallable") &&
                methodName.equals("run")) ||
            (className.equals("com.github.fromage.quasi.strands.dataflow.Var") &&
