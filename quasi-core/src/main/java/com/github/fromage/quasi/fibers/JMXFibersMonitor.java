...
import com.github.fromage.quasi.common.monitoring.Counter;
import com.github.fromage.quasi.common.monitoring.MonitoringServices;
...
class JMXFibersMonitor extends StandardEmitterMBean implements FibersMonitor, NotificationListener, FibersMXBean {
    ...
    public JMXFibersMonitor(String name, FiberScheduler scheduler, boolean detailedInfo) {
        ...
        this.mbeanName = "com.github.fromage.quasi:type=Fibers,name=" + name;
        registerMBean();
    ...
    private static class RunawayFiberNotification extends Notification {
        static final String NAME = "com.github.fromage.quasi.fibers.runawayfiber";
