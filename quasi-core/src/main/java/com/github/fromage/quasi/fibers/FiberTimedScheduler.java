...
import com.github.fromage.quasi.concurrent.util.SingleConsumerNonblockingProducerDelayQueue;
import com.github.fromage.quasi.strands.Strand;

public class FiberTimedScheduler {
    private static final boolean USE_LOCKFREE_DELAY_QUEUE = SystemProperties.isEmptyOrTrue("com.github.fromage.quasi.fibers.useLockFreeDelayQueue");
    private static final boolean DETECT_RUNAWAY_FIBERS = SystemProperties.isNotFalse("com.github.fromage.quasi.fibers.detectRunawayFibers");
    ...
    public FiberTimedScheduler(FiberScheduler scheduler, ThreadFactory threadFactory, FibersMonitor monitor) {
        ...
        this.workQueue = USE_LOCKFREE_DELAY_QUEUE ? new SingleConsumerNonblockingProducerDelayQueue<ScheduledFutureTask>() : new com.github.fromage.quasi.concurrent.util.DelayQueue<ScheduledFutureTask>();
