...
import com.github.fromage.quasi.common.monitoring.MonitorType;
 ...
 * <ul>
 * <li>{@code "com.github.fromage.quasi.fibers.DefaultFiberPool.parallelism"} - the number of threads in the default scheduler. By default, set equal to the number of available cores.</li>
 * <li>{@code "com.github.fromage.quasi.fibers.DefaultFiberPool.exceptionHandler"} - the name of the class to be used as the {@link UncaughtExceptionHandler UncaughtExceptionHandler}
 * (an instance is constructed using a public default constructor)</li>
 * <li>{@code "com.github.fromage.quasi.fibers.DefaultFiberPool.monitor"} - the {@link MonitorType monitor type} used to monitor the underlying {@code ForkJoinPool}.
 * May be {@code "JMX"} (the defualt), {@code "METRICS"}, or {@code "NONE"}.</li>
 * <li>{@code "com.github.fromage.quasi.fibers.DefaultFiberPool.detailedFiberInfo"} - whether the fibers monitor collects detailed information about running fibers.
...
public class DefaultFiberScheduler {
    private static final String PROPERTY_PARALLELISM = "com.github.fromage.quasi.fibers.DefaultFiberPool.parallelism";
    private static final String PROPERTY_EXCEPTION_HANDLER = "com.github.fromage.quasi.fibers.DefaultFiberPool.exceptionHandler";
    private static final String PROPERTY_THREAD_FACTORY = "com.github.fromage.quasi.fibers.DefaultFiberPool.threadFactory";
    private static final String PROPERTY_MONITOR_TYPE = "com.github.fromage.quasi.fibers.DefaultFiberPool.monitor";
    private static final String PROPERTY_DETAILED_FIBER_INFO = "com.github.fromage.quasi.fibers.DefaultFiberPool.detailedFiberInfo";
